...
export class Bdecoder {
   ...
   */
  static toUnit8Array(value: string): Uint8Array | undefined {
    if (!this.isNotUtf8ByteStr(value)) {
      return undefined
    }
   ...
   * @returns
   */
  static isNotUtf8ByteStr(value: string) {
    if (typeof value !== 'string') {
      return false
    }

    // 校验格式
    if (!value.startsWith('Unit8Array[') || !value.endsWith(']')) {
      return false
    }
